            ...
            if (scelta == 1) {
                ...
                while (adminChoice != 0 && adminChoice != 5) {
                    ...
                    if (password == 1234) {
                            ...
                            if (adminChoice == 1) {
                                ...
                                while (vehicleChoice != 0 && vehicleChoice != 5) {
                                    ...
                                    if (vehicleChoice == 1) {
                                        ...
                                        System.out.println("Digita 1 per continuare");
                                        System.out.println("Digita 5 per tornare indietro");
                                        System.out.println("Digita 0 per uscire");
                                        int retry = scanner.nextInt();
                                        if (retry == 5) vehicleChoice = 5;
                                        if (retry == 0) vehicleChoice = 0;
                                    } else if (vehicleChoice == 2) {
                                        int maintChoice = -1;
                                        while (maintChoice != 0 && maintChoice != 5) {
                                            ...
                                            System.out.println("Digita 3 per vedere se un mezzo è in manutenzione");
                                            System.out.println("Digita 4 per vedere tutte le manutenzioni");
                                            System.out.println("Digita 5 per tornare indietro");
                                            System.out.println("Digita 0 per uscire");
                        ...
                        System.out.println("Digita 0 per uscire");
                        int retry = scanner.nextInt();
                        if (retry == 5) adminChoice = 5;
                        if (retry == 0) adminChoice = 0;
                    }
                }
            } else if (scelta == 2) {
                int userChoice = -1;
                while (userChoice != 0 && userChoice != 5) {
                    ...
                    if (userChoice == 1) {
                        ...
                        System.out.println("Digita 0 per uscire");
                        int retry = scanner.nextInt();
                        if (retry == 5) userChoice = 5;
                        if (retry == 0) userChoice = 0;
                    }
                }
            }
        }
